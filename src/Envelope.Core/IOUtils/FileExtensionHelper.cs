...
public class FileExtensionHelper
{
	...
	private static readonly Lazy<byte[]> _pdfSignature = new(() => new byte[] { 0x25, 0x50, 0x44, 0x46 });
	...
	private static readonly Lazy<byte[]> _bmpSignature = new(() => new byte[] { 0x42, 0x4D });
