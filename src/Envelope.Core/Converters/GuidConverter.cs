...
{
	public static readonly Guid ENVELOPE_STRING_NAMESPACE = new("F78ACC30-2EA5-4F24-9A9E-7C7917163097");
	...
	/// <returns>A UUID derived from the <see cref="ENVELOPE_STRING_NAMESPACE"/> namespace and value.</returns>
	public static Guid ToGuid(string value) =>
		ToGuid(value, ENVELOPE_STRING_NAMESPACE, StringUuidVersionHashAlgorithm.SHA1);
