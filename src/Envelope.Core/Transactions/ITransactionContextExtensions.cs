...
public static class ITransactionContextExtensions
{
	public static T GetItem<T>(this ITransactionContext transactionContextRegister, string key)
	{
	...
	public static T? GetItemIfExists<T>(this ITransactionContext transactionContextRegister, string key)
	{
		if (transactionContextRegister == null)
			throw new ArgumentNullException(nameof(transactionContextRegister));
	...
	public static bool TryGetItem<T>(this ITransactionContext transactionContextRegister, string key, [NotNullWhen(true)] out T? value)
	{
		if (transactionContextRegister == null)
			throw new ArgumentNullException(nameof(transactionContextRegister));
	...
	public static TTransactionContextRegister AddItem<TTransactionContextRegister, T>(this TTransactionContextRegister transactionContextRegister, string key, T value, bool force = false)
		where TTransactionContextRegister : ITransactionContext
	{
		if (transactionContextRegister == null)
			throw new ArgumentNullException(nameof(transactionContextRegister));
