...
public class TransactionContext : ITransactionContext, ITransactionBehaviorObserverConnector, ITransactionObserverConnector, IDisposable
...
#endif
{
	...
	protected internal TransactionContext()
	{
	...
	protected internal TransactionContext(Action<ITransactionBehaviorObserverConnector>? configureBehavior, Action<ITransactionObserverConnector>? configure)
		: this()
	{
	...
	public IConnectHandle ConnectTransactionManager(ITransactionBehaviorObserver manager)
		=> _transactionBehaviorObserverConnector.ConnectTransactionManager(manager);
